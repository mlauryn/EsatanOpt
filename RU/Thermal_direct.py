...
if __name__ == "__main__":
    ...
    model = ThermalGroup(n=n, conductors=cond_nodes, opticals=vf_nodes, area=area, SF=shape_factors, VF=VF, GL_init=GL_init, GR_init=GR_init, QI_init=QI_init, QS_init=QS_init)
