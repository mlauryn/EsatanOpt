...
prob.driver.opt_settings = {'rhobeg':0.1, 'maxiter': 500, 'tol':1e-02, 'catol':1e-02}

prob.model.add_design_var('batH', lower = 0.1)
prob.model.add_design_var('propH', lower = 0.1)
prob.model.add_design_var('eps', lower = 0.02, upper=0.8)
prob.model.add_design_var('alp', lower = 0.19, upper=0.48)
...
""" prob.model.add_constraint('batH', lower = 0.01)
prob.model.add_constraint('propH', lower = 0.01)
prob.model.add_constraint('epsX', lower = 0.02, upper=0.8)
#prob.model.add_constraint('alpX', lower = 0.23, upper=0.48)
prob.model.add_constraint('eps-X', lower = 0.02, upper=0.8)
#prob.model.add_constraint('alp-X', lower = 0.23, upper=0.48)
prob.model.add_constraint('epsY', lower = 0.02, upper=0.8)
#prob.model.add_constraint('alpY', lower = 0.23, upper=0.48)
prob.model.add_constraint('eps-Y', lower = 0.02, upper=0.8)
#prob.model.add_constraint('alp-Y', lower = 0.23, upper=0.48)
prob.model.add_constraint('epsZ', lower = 0.02, upper=0.8)
#prob.model.add_constraint('alpZ', lower = 0.23, upper=0.48)
prob.model.add_constraint('eps-Z', lower = 0.02, upper=0.8)
#prob.model.add_constraint('alp-Z', lower = 0.23, upper=0.48) """
""" prob.model.add_constraint('GlBat1', lower = 0.4, upper=26.0)
prob.model.add_constraint('GlBat2', lower = 0.4, upper=26.0) """
""" prob.model.add_constraint('GlMain', lower = 0.004, upper=1.0)
prob.model.add_constraint('GlProp', lower = 0.004, upper=1.0) """
""" prob.model.add_constraint('ci1', lower = 0.013, upper=0.072)
prob.model.add_constraint('ci2', lower = 0.015, upper=0.084)
prob.model.add_constraint('ci3', lower = 0.015, upper=0.084)
prob.model.add_constraint('ci4', lower = 0.008, upper=0.026)
prob.model.add_constraint('ci5', lower = 0.008, upper=0.026)
prob.model.add_constraint('ci6', lower = 0.013, upper=0.072)
prob.model.add_constraint('ci7', lower = 0.013, upper=0.072)
prob.model.add_constraint('ci8', lower = 0.013, upper=0.072)
prob.model.add_constraint('ci9', lower = 0.015, upper=0.084)
prob.model.add_constraint('ci10', lower = 0.008, upper=0.026)
prob.model.add_constraint('ci11', lower = 0.008, upper=0.026)
prob.model.add_constraint('ci12', lower = 0.015, upper=0.084) """
